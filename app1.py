...
sqft = st.number_input("Enter Square Feet", min_value=100, max_value=10000, step=10)
...
if st.button("Predict Price"):
    # Step 1: Create an empty array of all features (set to 0)
    x_input = np.zeros(len(feature_names))

    # Step 2: Assign values to the first three features
    try:
    ...
    # Step 3: Handle one-hot encoding for the location
    ...
    # Step 4: Debugging: Check input shape
    print("Input Vector Shape:", x_input.shape)

    # Step 5: Make prediction using XGBoost model
